...
export default function MovingBookSuccess() {
    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-[#F0F0F0] px-4 py-10">
      <div className="w-full max-w-120 flex flex-col items-center gap-8 text-center"
        ...
        <div className="flex flex-col gap-3">
          <h1 className="font-rethink font-medium leading-[130%] tracking-[-1.248px] m-0" style={{ color: "#0F172B", fontSize: "32px" }}>Thank you!</h1>
          <p className="font-rethink font-normal leading-[140%] m-0" style={{ color: "#656565", fontSize: "16px" }}>
            Our moving specialists will review your project and contact you within 24 hours with a custom quote.
          </p>
        </div>
