                ...
                <div key={s.header} className="relative rounded-2xl overflow-hidden cursor-pointer group min-h-70 sm:min-h-80">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-4">
                    <div className="flex flex-col items-start gap-2 p-4 rounded-lg"
                      ...
                      <h3 className="font-rethink font-medium leading-[140%] tracking-[-0.936px] m-0 text-white text-xl sm:text-2xl">{s.header}</h3>
                      <p className="font-rethink font-normal leading-[140%] m-0 text-[#ECEEF0] text-xs">{s.sub_header}</p>
                    </div>
                  </div>
                </div>
              ))}
