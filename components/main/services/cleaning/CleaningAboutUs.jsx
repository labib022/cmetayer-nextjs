...
export default function CleaningAboutUs() {
  return (
      ...
      <div className="max-w-360 mx-auto flex flex-col items-center gap-10 lg:gap-16 px-4 py-12 sm:px-8 sm:py-16 md:px-12 md:py-20 lg:px-16 lg:py-24">
        ...
        <div className="flex flex-col lg:flex-row items-start gap-10 lg:gap-16 w-full">
          ...
          <div className="flex flex-col gap-6 lg:gap-8 flex-1 w-full">
            <div className="flex flex-col gap-3 lg:gap-4">
              ...
              <p className="font-rethink font-normal leading-[140%] m-0 text-[#677489] text-base sm:text-lg">
                ...
                We ensure your home sparkles! Book today for a spotless experience!
              </p>
            </div>

            <div className="flex flex-col gap-4 lg:gap-5">
              <h3 className="m-0 font-semibold leading-6 text-[#0E1109] text-lg sm:text-xl" style={{ fontFamily: '"Plus Jakarta Sans", sans-serif' }}>
                Included Services
              </h3>
              <div className="flex flex-col gap-3 lg:gap-4">
                {INCLUDED_SERVICES.map((item) => (
                  <div key={item} className="flex items-center gap-3">
                    ...
                    <span className="font-rethink font-normal leading-[140%] text-[#656565] text-base sm:text-lg">{item}</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div
            ...
            style={{ background: `url(${movingImg}) lightgray 50% / cover no-repeat` }}
          >
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 sm:gap-5 w-full p-4 sm:p-5 rounded-3xl border border-[#E3E8EF] bg-white">
              <div className="flex flex-col gap-1">
                <span className="font-rethink font-normal leading-[140%] text-[#677489] text-base">Start From</span>
                <div className="flex items-baseline gap-1">
                  <span className="font-rethink font-medium leading-[130%] tracking-[-1.248px] text-[#08203C] text-3xl sm:text-[32px]">$75</span>
                  <span className="font-rethink font-medium leading-[140%] tracking-[-0.936px] text-[#08203C] text-xl sm:text-2xl">/ hr</span>
                </div>
              </div>

              {/* ✅ Link to → href */}
              <Link
                href="/services/cleaning/book/step-1"
              ...
              >
                <span className="font-rethink text-white font-semibold text-base leading-[140%]">Book Now</span>
                <span className="flex items-center justify-center w-9 h-9 rounded-full text-white text-base shrink-0 bg-white/15">→</span>
              </Link>
            </div>
          </div>
